...
public interface IResizeRegistry<T> {

	IResizeConfiguration addResizeListener(IResizeListener listener);

	T removeResizeListener(IResizeListener listener);

	T notifyResizeListeners();

	T notifyResizeListener(IResizeListener listener);
