...
public class GWTDisplay extends DisplayTemplate implements IDisplay,
	...
	public static final String BROWSER_WARNING_ZOOM_CHROME = "You are using a zoom level different from 100%. This can lead to unexpected behaviour: please switch to zoom level 100%, e.g. by clicking Ctrl+0.";
