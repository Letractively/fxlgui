...
import co.fxl.gui.automation.api.IBulkTableWidgetListener;
...
public class BulkTableWidgetListener {
	...
	public static <T> IBulkTableWidgetListener<T> instance() {
		return (IBulkTableWidgetListener<T>) instance;
	}
