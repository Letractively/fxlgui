...
privileged aspect ScrollTableWidgetImplLayout {
	...
	void around(final ScrollTableWidgetImpl widget) : call(protected void ScrollTableWidgetImpl.addFilter()) 
		...
		widget.topPanel.cell(0, 0).clear().panel().horizontal().addSpace(8)
				...
				.addClickListener(new IClickListener() {
					...
					public void onClick() {
						...
						widget.filter.addCancelListener(new IClickListener() {
							@Override
							public void onClick() {
								popUp.visible(false);
							}
						});
						widget.filter.addFilterListener(new IFilterListener() {
							@Override
