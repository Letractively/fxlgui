...
public class GWTDisplay extends DisplayTemplate implements IDisplay,
	...
	public static final String BROWSER_WARNING_ZOOM_CHROME = "You are using a zoom level different from 100%. Please switch to zoom level 100% to avoid unexpected behaviour (for example by clicking Ctrl+0).";
